...
public class ModifySubActivity extends Activity {
    ...
    String serName, serPrice, serStartDate, payType;
    Date date;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        serPrice = getIntent.getStringExtra("service_price");
        serStartDate = getIntent.getStringExtra("service_start_date");
        payType = getIntent.getStringExtra("payment_type");


        editName.setText(serName);
        editPrice.setText(serPrice);
    ...
    public boolean checkDate(Date inputDate, Date currentDate) {
